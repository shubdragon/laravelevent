                    ...
                    <div class="p-4 bg-white shadow-lg rounded-md">
                        ...
                        <div class="flex pt-8 flex-wrap 1xl:flex-nowrap">
                            ...
                            <div class="">
                                ...
                                <p
                                    class="font-poppins font-normal text-sm leading-5 text-gray-200">
                                    {{ __('Email') }}</p>
                                <p
                                    class="font-poppins font-medium text-sm text-gray-200">
                                    {{ $data->email ?? '' }}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex pt-8 flex-wrap 1xl:flex-nowrap">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <p
                                        class=" font-poppins font-medium text-sm text-gray-200 pt-1">
                                        {{ $data->address ?? '' }}</p>
                            ...
                            <div>
                                ...
                                <div class="flex mt-2">
                                    ...
                                    <a href="{{ $social->Facebook }}" class="link-one">
                                        <i class="fa-brands fa-facebook fa-1x  mr-5 z-20 text-primary"></i>
                                    </a>
                                    <a href="{{ $social->Twitter }}" class="link-one">
                                        <i class="fa-brands fa-twitter fa-1x  mr-5 z-20 text-primary"></i>
                                    </a>
                                    <a href="{{ $social->Instagram }}" class="link-one">
                                        <i class="fa-brands fa-instagram fa-1x  mr-5 z-20 text-primary"></i>
                                    </a>
                                    <a href="{{ $social->Pinterest }}" class="link-one">
                                        <i class="fa fa-pinterest-p text-primary fa-1x " aria-hidden="true"></i>
                                    </a>
                                    <style>
                                        .fa-2x {
                                            font-size: 24px;
