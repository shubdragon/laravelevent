                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="allday" id=""
                                                ...
                                                <option value="1" {{$ticket->allday == 1 ? 'selected':''}}>{{ __('Attendees can use it multiple times') }}
                                                </option>
                                                <option value="0" {{$ticket->allday == 0 ? 'selected':''}}>{{ __('Attendees can use it once') }}</option>
                                            </select>
                                            @error('allday')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
