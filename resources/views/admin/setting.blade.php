                            ...
                            <div class="collapse mt-3" id="payment-setting">
                                ...
                                <form method="post" action="{{ url('save-payment-setting') }}">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <label
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Flutterwave secret Debugg mode') }}</label>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="onesignal_app_id"
                                                placeholder="{{ __('OneSignal App Id') }}" value="{{$setting->onesignal_app_id}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="onesignal_project_number"
                                                placeholder="{{ __('Onesignal Project Number') }}" value="{{$setting->onesignal_project_number}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="onesignal_api_key"
                                                placeholder="{{ __('Onesignal Api key') }}" value="{{$setting->onesignal_api_key}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="onesignal_auth_key"
                                                placeholder="{{ __('Onesignal Auth Key') }}" value="{{$setting->onesignal_auth_key}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="or_onesignal_app_id"
                                                placeholder="{{ __('OneSignal App Id') }}" value="{{$setting->or_onesignal_app_id}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="or_onesignal_project_number"
                                                placeholder="{{ __('Onesignal Project Number') }}" value="{{$setting->or_onesignal_project_number}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="or_onesignal_api_key"
                                                placeholder="{{ __('Onesignal Api key') }}" value="{{$setting->or_onesignal_api_key}}"
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-9">
                                            ...
                                            <input type="text" name="or_onesignal_auth_key"
                                                placeholder="{{ __('Onesignal Auth Key') }}" value="{{$setting->or_onesignal_auth_key}}"
